...
[qd1,dqd1,ddqd1] = Get_Trape_Plan(t1,t2,t3,Acc,Dec,ps,sign(pe-ps),dt,ts1);
tsm1 = linspace(0,ts1,ceil(ts1/dt));
...
[qd2,dqd2,ddqd2] = Get_Trape_Plan(t1,t2,t3,Acc,Dec,ps,sign(pe-ps),dt,ts2);
tsm2 = linspace(0,ts2,ceil(ts2/dt));

qd = [qd,qd1,qd2];
dqd = [dqd,dqd1,dqd2];
ddqd = [ddqd,ddqd1,ddqd2];
tsm = [tsm,ts+tsm1,ts+ts1+tsm2];
